...
from test.ui import test_login_new, test_system_teams, \
    test_administration, test_administration_customers, test_administration_projects, test_administration_activities, \
    test_time_tracking_times, test_invoices, test_invoices_create
